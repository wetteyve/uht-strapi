...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    licenced_players_allowed: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
    max_age: Attribute.Integer;
    max_teams: Attribute.Integer;
    name: Attribute.String & Attribute.Required;
    price: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<80>;
    short_key: Attribute.String & Attribute.Required & Attribute.Unique;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::category.category',
      'oneToOne',
...
export interface ApiEmailEmail extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    edition_nr: Attribute.Integer & Attribute.Required;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::page.page', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    linkage: Attribute.Enumeration<['navbar', 'footer']> &
      Attribute.Required &
